...
function FormEmprestimo(): JSX.Element {
    ...
    useEffect(() => {
        /*Função para buscar informações dos alunoss */
        ...
        /* Função para buscar informações dos Livros*/
    ...
    /** Função para buscar informações dos empréstimos */
    ...
    return (
        <section className={estilo['sec-form-emprestimo']}>
            ...
            <form action="" method="post" className={estilo['form-emprestimo']} onSubmit={(e) => { e.preventDefault(); handleSubmit(formData) }}>
